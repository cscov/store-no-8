...
item1 = Item.create(name: "red apples", price: 1.50, order_id: order2.id)
item2 = Item.create(name: "cara cara oranges", price: 2.50, order_id: order1.id)
item3 = Item.create(name: "russet potatoes", price: 5.99, order_id: order2.id)
...
item9 = Item.create(name: "mushrooms", price: 2.50, order_id: order2.id)

...
item1 = Item.create(name: "red apples", price: 1.50, price_cents: 150)
item2 = Item.create(name: "cara cara oranges", price: 2.50, price_cents: 250)
item3 = Item.create(name: "russet potatoes", price: 5.99, price_cents: 599)
item4 = Item.create(name: "dish soap", price: 3.99, price_cents: 399)
item5 = Item.create(name: "toothpaste", price: 8.99, price_cents: 899)
item6 = Item.create(name: "tortilla chips", price: 3.99, price_cents: 399)
item7 = Item.create(name: "angel hair pasta", price: 4.50, price_cents: 450)
item8 = Item.create(name: "chocolate ice cream", price: 8.50, price_cents: 850)
item9 = Item.create(name: "mushrooms", price: 2.50, price_cents: 250)
item10 = Item.create(name: "bell peppers", price: 5.99, price_cents: 599)
